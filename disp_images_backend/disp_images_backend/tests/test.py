...
from disp_images_backend.views import RequestCommands as RequestCommands
...
class TestCalls(TestCase):
    ...
    def test_get_image_name(self):
        ...
        response = self.client.get('/disp_images/',{'command':RequestCommands.GET_PREV_IMAGE_DETAILS})
        self.assertEqual(response.status_code, 200)
        ...
        response = self.client.get('/disp_images/',{'command':RequestCommands.GET_NEXT_IMAGE_DETAILS})
        self.assertEqual(response.status_code, 200)
        ...
        response = self.client.get('/disp_images/',{'command':RequestCommands.READ_IMAGE_DETAILS})
        self.assertEqual(response.status_code, 200)
