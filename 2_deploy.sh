...
rsync ./docker/.env  itay@10.0.0.15:/home/itay/docker-compose
rsync ./deploy_on_remote_host.sh itay@10.0.0.15:/home/itay
echo 'done'

# connecting to remote host
echo 'pulling images at remote host'
ssh itay@10.0.0.15 'chmod a+x deploy_on_remote_host.sh'
ssh itay@10.0.0.15 './deploy_on_remote_host.sh'
